...
public class CharacterRecognizerExample  {
    public static void main(String[] args) throws IOException {
		...
		//Printing all biases and weights to check if they were initialized properly
		
		// System.out.println(net.biases.size());
		// for (int i = 0; i < net.biases.size(); i++) {
		// 	Double[] bias = net.biases.get(i);
		// 	for (int j = 0; j < bias.length; j++) {
		// 		System.out.println(bias[j]);
		// 	}
		// }
		
		// System.out.println(net.weights.size());
		// for (int i = 0; i < net.weights.size(); i++) {
		// 	Double[][] weight = net.weights.get(i);
